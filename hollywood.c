...
static gboolean on_map_click(GtkWidget * widget, GdkEventButton * event, gpointer user_data) {
  ...
  if (event -> type == GDK_2BUTTON_PRESS && (left_button || right_button)) {
    ...
    if (left_button) {
        ...
        find_closest_point(lat, lon, "/home/malek/Desktop/TD_INFO/IN104/UCSD-Graphs-master/data/maps/hollywood_large.map", lat_result, lon_result);
...
main(int argc, char ** argv) {
  ...
  file_plot("/home/malek/Desktop/TD_INFO/IN104/UCSD-Graphs-master/data/maps/hollywood_large.map", map, graph);
